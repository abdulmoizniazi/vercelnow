...
const components: { title: string; href: string; description: string }[] = [
  {
    ...
    href: "#",
    description:
      "An amazing collection of Tops for your wardrobe",
  },
  {
    title: "Pants",
    href: "#",
    description:
      "An amazing collection of Pants for your wardrobe",
  },
  {
    title: "Jewelary",
    href: "#",
    description:
      "An amazing collection of Jewelary for your wardrobe",
  },
  {
    title: "Shoes",
    href: "#",
    description:
      "An amazing collection of Shoes for your wardrobe",
  },
]
